...
if ! ask "Dieses Installationsprogramm funktioniert nur für Anwender von ${bf}Leibniz-Rechenzentrum (LRZ) der Bayerischen Akademie der Wissenschaften${n} in der Benutzergruppe: ${bf}eduroam.mwn.de.${n}" "Weiter" 1 ; then exit; fi
